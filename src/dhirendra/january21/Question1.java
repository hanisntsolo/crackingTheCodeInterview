package dhirendra.january21;


//There is a JAR full of candies for sale at a mall counter.
// JaR capacity N, candies quantity M,
...
public class Question1 {
    ...
    public static void main(String[] args) {
        // declaration for main input
        while(!false) {
            int jarCapacity = 10;
            System.out.println("How many candies do you want!");
            Scanner sc = new Scanner(System.in);
            int quantity = sc.nextInt();
            if(quantity>jarCapacity) {
                System.out.println("Please enter candies less than 10");
            } else {
                System.out.println("NUMBER OF CANDIES SOLD: "+ quantity);
                System.out.println("NUMBER OF CANDIES LEFT: "+ (jarCapacity-quantity));
            }
        }
    }
}
